...
let {name: uName,  years: uAge, isAdmin = false}= user1;
...
console.log(isAdmin);
    ...
    // Додайте до нього властивості age і salary, не змінюючи початковий об'єкт (має бути створено новий об'єкт, який включатиме 
    ...
    let  {name, surname, age, salary} = employee;

    console.log({name, surname, age: 45, salary: 2000});
